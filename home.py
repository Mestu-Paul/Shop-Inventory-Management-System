...
def addHome(root):
    ...
    # ---------------------------operation button--------------------------- #
    left_frame_btn_manage_item = tk.Button(left_frame,text='Manage Item', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:manage_item(root))
    left_frame_btn_manage_item.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_purchase_item = tk.Button(left_frame,text='Purchase Item', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:purchase_item(root))
    left_frame_btn_purchase_item.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_check_stock = tk.Button(left_frame,text='Check Stock', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:check_stock(root))
    left_frame_btn_check_stock.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_demage_stock = tk.Button(left_frame,text='Demage Stock', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:check_demage_stock(root))
    left_frame_btn_demage_stock.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_purchase_report = tk.Button(left_frame,text='Purchase Report', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:purchase_report(root))
    left_frame_btn_purchase_report.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_sales_report = tk.Button(left_frame,text='Sales Report', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:sales_report(root))
    left_frame_btn_sales_report.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_item_sales_report = tk.Button(left_frame,text='Item Sales Report', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:item_sales_report(root))
    left_frame_btn_item_sales_report.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_expenditure = tk.Button(left_frame,text='Expenditure', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:expenditure(root))
    left_frame_btn_expenditure.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_expenditure_report = tk.Button(left_frame,text='Expenditure Report', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:expenditure_report(root))
    left_frame_btn_expenditure_report.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_staff_manager = tk.Button(left_frame,text='Staff Manager', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:staff_manager(root))
    left_frame_btn_staff_manager.pack(side=tk.TOP,fill=tk.X,padx=5, pady=2)

    left_frame_btn_contact_book = tk.Button(left_frame,text='Contact Book', fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:contact_book(root))
    ...
    left_frame_btn_11 = tk.Button(left_frame,text="Refresh", fg=color.color_list[3], bg=color.color_list[5], font=('Times New Roman1',10),command=lambda:refresh(root))
    ...
    # delete item
    left_frame_btn_delete = tk.Button(middle_frame, fg=color.color_list[3], bg=color.color_list[2],font=('Times New Roman',14), text='Delete')
    left_frame_btn_delete.place(relx=0.02,rely=0.92, height=25)

    check_free = tk.IntVar()
    tk.Checkbutton(middle_frame, bg=color.color_list[2], font=('Times New Roman',14), text='Free', variable=check_free).place(relx=0.37,rely=0.92,height=25)
    # add item to sell
    left_frame_btn_add = tk.Button(middle_frame, fg=color.color_list[3], bg=color.color_list[2],font=('Times New Roman',14), text='Add item')
    ...
    middle_frame_lbl_item_name = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Item Name :')
    middle_frame_lbl_item_name.place(relx=0.5, y=90, relwidth=0.48, relheight=0.04)

    # Item Code (at left_frame1)
    middle_frame_lbl_item_code = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Item Code :')
    middle_frame_lbl_item_code.place(relx=0.5, y=120, relwidth=0.48, relheight=0.04)

    # Item Group (at left_frame1)
    middle_frame_lbl_item_group = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Item Group :')
    middle_frame_lbl_item_group.place(relx=0.5, y=150, relwidth=0.48, relheight=0.04)

    # Company (at left_frame1)
    middle_frame_lbl_company = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Company :')
    middle_frame_lbl_company.place(relx=0.5, y=180, relwidth=0.48, relheight=0.04)

    # Shelf No. (at left_frame1)
    middle_frame_lbl_shelf_no = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Shelf No. :')
    middle_frame_lbl_shelf_no.place(relx=0.5, y=210, relwidth=0.48, relheight=0.04)

    # Available Quantity (at left_frame1)
    middle_frame_lbl_avl_quantity = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Available Quantity :')
    middle_frame_lbl_avl_quantity.place(relx=0.5, y=240, relwidth=0.48, relheight=0.04)

    # Price
    middle_frame_lbl_price = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Price :')
    middle_frame_lbl_price.place(relx=0.5, y=330, relwidth=0.48, relheight=0.04)

    # Item Total Price (at left_frame1)
    middle_frame_lbl_total_price = tk.Label(middle_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',14), text='Item Total Price :')
    ...
    # total item 
    right_frame_payment_info_frame_lbl_1 = tk.Label(right_frame_payment_info_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',purchase_font), text='Total item :')
    right_frame_payment_info_frame_lbl_1.place(relx=0.42, rely=0.01, relwidth=0.4, relheight=0.08)

    # total price
    right_frame_payment_info_frame_lbl_2 = tk.Label(right_frame_payment_info_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',purchase_font), text='Total price :')
    right_frame_payment_info_frame_lbl_2.place(relx=0.42, rely=0.1, relwidth=0.4, relheight=0.08)

    # discount 
    right_frame_payment_info_frame_lbl_5 = tk.Label(right_frame_payment_info_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',purchase_font), text='Total item :')
    right_frame_payment_info_frame_lbl_5.place(relx=0.42, rely=0.2, relwidth=0.4, relheight=0.08)

    # Payable
    right_frame_payment_info_frame_lbl_7 = tk.Label(right_frame_payment_info_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',purchase_font), text='Total item :')
    ...
    # change/due
    right_frame_payment_info_frame_lbl_10 = tk.Label(right_frame_payment_info_frame,bg=color.color_list[7], anchor='w', font=('Times New Roman',purchase_font), text='Total item :')
