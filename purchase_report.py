...
def purchase_report(root):
    ...
    top_frame_lbl_2 = tk.Label(top_frame,bg=color.light_grey,anchor='w', font=('Times New Roman',12), text='From :')
    top_frame_lbl_2.place(relx=0.01,rely=.4,relwidth=0.1)
    
    top_frame_lbl_3 = tk.Label(top_frame,bg=color.light_grey,anchor='w', font=('Times New Roman',12), text='To :')
