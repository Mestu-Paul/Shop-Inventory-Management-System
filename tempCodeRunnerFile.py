...
top_frame_0.place(relx=0,rely=0,relwidth=1,relheight=0.125)
# ---------------------------------------------------------------------
# logo  (at frame 0)
...
top_frame_1.place(relx=0,rely=0.125,relwidth=1,relheight=0.045)
# ---------------------------------------------------------------------
# welcome  (at frame 1)
...
# ---------------------------- label --------------------------#
# search type
left_frame_2_frame_customer_info_lbl_0 = tk.Label(left_frame_2_frame_customer_info,bg=left2_bg, anchor='w', font=('Times New Roman',10), text='Search by :')
left_frame_2_frame_customer_info_lbl_0.place(relx=0.01, rely=0.01, relwidth=0.4, relheight=0.08)

# search box
left_frame_2_frame_customer_info_lbl_1 = tk.Label(left_frame_2_frame_customer_info,bg=left2_bg, anchor='w', font=('Times New Roman',10), text='Query :')
...
# customer name 
left_frame_2_frame_customer_info_lbl_2 = tk.Label(left_frame_2_frame_customer_info,bg=left2_bg, anchor='w', font=('Times New Roman',10), text='Name :')
left_frame_2_frame_customer_info_lbl_2.place(relx=0.01, rely=0.3, relwidth=0.4, relheight=0.08)

# customer pre-balance
left_frame_2_frame_customer_info_lbl_3 = tk.Label(left_frame_2_frame_customer_info,bg=left2_bg, anchor='w', font=('Times New Roman',10), text='Pre-balance :')
left_frame_2_frame_customer_info_lbl_3.place(relx=0.01, rely=0.4, relwidth=0.4, relheight=0.08)

# customer current balance
left_frame_2_frame_customer_info_lbl_4 = tk.Label(left_frame_2_frame_customer_info,bg=left2_bg, anchor='w', font=('Times New Roman',10), text='Current-balance :')
left_frame_2_frame_customer_info_lbl_4.place(relx=0.01, rely=0.5, relwidth=0.4, relheight=0.08)

# customer contact no
left_frame_2_frame_customer_info_lbl_5 = tk.Label(left_frame_2_frame_customer_info,bg=left2_bg, anchor='w', font=('Times New Roman',10), text='Contact :')
...
# total item 
left_frame_2_frame_payment_info_lbl_0 = tk.Label(left_frame_2_frame_payment_info,bg=left2_bg, anchor='w', font=('Times New Roman',12), text='Total item :')
left_frame_2_frame_payment_info_lbl_0.place(relx=0.01, rely=0.01, relwidth=0.4, relheight=0.08)
...
left_frame_2_frame_payment_info_lbl_2.place(relx=0.01, rely=0.1, relwidth=0.4, relheight=0.08)
left_frame_2_frame_payment_info_lbl_3 = tk.Label(left_frame_2_frame_payment_info,bg=left2_bg, anchor='w', font=('Times New Roman',12), text='Total item :')
left_frame_2_frame_payment_info_lbl_3.place(relx=0.42, rely=0.1, relwidth=0.4, relheight=0.08)

# discount 
left_frame_2_frame_payment_info_lbl_4 = tk.Label(left_frame_2_frame_payment_info,bg=left2_bg, anchor='w', font=('Times New Roman',12), text='Discount :')
left_frame_2_frame_payment_info_lbl_4.place(relx=0.01, rely=0.2, relwidth=0.4, relheight=0.08)
...
# Payable
left_frame_2_frame_payment_info_lbl_6 = tk.Label(left_frame_2_frame_payment_info,bg=left2_bg, anchor='w', font=('Times New Roman',12), text='Payable :')
left_frame_2_frame_payment_info_lbl_6.place(relx=0.01, rely=0.3, relwidth=0.4, relheight=0.08)
...
# total paid
left_frame_2_frame_payment_info_lbl_8 = tk.Label(left_frame_2_frame_payment_info,bg=left2_bg, anchor='w', font=('Times New Roman',12), text='Total paid :')
left_frame_2_frame_payment_info_lbl_8.place(relx=0.01, rely=0.4, relwidth=0.4, relheight=0.08)
...
# change/due
left_frame_2_frame_payment_info_lbl_9 = tk.Label(left_frame_2_frame_payment_info,bg=left2_bg, anchor='w', font=('Times New Roman',12), text='Change/due :')
left_frame_2_frame_payment_info_lbl_9.place(relx=0.01, rely=0.5, relwidth=0.4, relheight=0.08)
...
def payment_method_select(event):
    left_frame_2_frame_payment_info_frame_payment_acount_lbl_11 = tk.Label(left_frame_2_frame_payment_info_frame_payment_acount, bg=left2_bg, anchor='w', font=('Times New Roman',12), text='Payment A/C :')
    ...
    tk.Checkbutton(left_frame_2_frame_payment_info_frame_payment_acount, bg=left2_bg, font=('Times New Roman',12), text='Set aa default', variable=default_payment_account).place(relx=0.6,rely=0.7)
